...
export default function Home() {
  ...
  const faqs: FaqsType[] = [
    ...
    },
    {
      ...
      answer:
        "To add your children to SLAYT, go to your parent account settings, then select ward management and follow the prompts to create profiles for your kids. You'll need to provide their names and ages.",
      isList: false,
    },
    {
    ...
    },
    {
      ...
      answer:
        "You can offer rewards like extra playtime, small treats, or other incentives to motivate your kids. Specify the rewards when assigning task, and kids can earn them by completing tasks.",
      isList: false,
    },
    {
      question: "Is SLAYT a free app, or are there in-app purchases?",
      answer:
        "SLAYT is available as a free app with optional in-app purchases for premium features or additional rewards. You can choose to use the free version or upgrade as needed. \nPremium feature will enable you create unlimited number kids, tasks and other cool features.",
      isList: false,
    },
  ];
    ...
    <main className={styles.home}>
      <div className={styles.hero}>
        <div className={styles.info}>
          ...
          <p>
            Discover SLAYT: The App That Makes Household Responsibilities Fun
      ...
      <div className={styles.help} id="about">
        <div className={styles.container}>
          <div className={styles.left}>
            ...
            <p>
              Fostering Responsible Growth: Empowering Tomorrow&apos;s Leaders
              Today. Our mission is to guide children in developing a strong
              sense of responsibility, setting the foundation for future
              success. SLAYT is not just an app; it&apos;s a tool for nurturing
              young minds and encouraging them to grow into responsible, capable
              individuals.
            </p>
            ...
            >
              <path
                d="M43.9357 83.2928C19.9535 81.6883 0.869007 52.1328 13.5357 31.0006C19.4468 20.6561 31.6701 14.5339 43.5135 15.1672C55.9057 16.9195 65.1734 28.0661 66.3134 40.1839C67.1157 52.0061 58.9035 65.4961 46.2157 65.855C39.249 65.9395 31.7123 60.9361 28.5457 54.9406C23.7746 46.9184 26.2868 35.455 35.259 32.0772C41.9301 29.5017 50.8812 33.9984 52.6546 41.1128C54.639 48.4384 44.8857 54.1384 39.2279 50.0639C32.9368 43.245 43.2812 37.8195 49.1079 42.4006C48.0101 35.7506 38.1512 31.9083 33.3801 37.3339C22.0435 48.7128 40.0935 69.6128 53.5623 60.0072C62.0068 54.1383 64.9623 41.4717 60.5712 32.7106C56.4334 23.6961 47.8623 17.0672 37.9612 18.7772C23.6901 20.6772 11.9101 33.1328 13.2612 48.0583C14.8868 66.2139 33.9923 84.7495 52.9923 78.8595C62.2601 76.2839 69.459 69.7183 74.2934 62.1395C81.9568 47.1717 84.2157 29.7972 79.149 13.7528C78.8323 12.8028 79.529 11.895 80.4368 11.6628C81.3657 11.4517 82.4212 11.895 82.7379 12.845C87.7412 28.6784 85.9045 45.0606 79.3601 60.1339C74.019 72.9272 57.869 84.4328 43.9779 83.2928H43.9357ZM46.1946 47.4039C46.7223 47.1084 47.039 46.9395 47.6935 46.3484C47.5457 46.095 47.4823 45.8206 47.5034 45.5461C45.9201 43.7517 42.289 43.1606 41.0434 45.5039C40.8746 46.2639 41.1912 46.9395 41.8034 47.615C42.9434 48.4595 45.3501 47.6572 46.1946 47.4039Z"
                fill="#00A3FF"
              />
            </svg>
          </div>
          <div className={styles.right}>
            <div>
              ...
              >
                <path
                  d="M20.1286 11.6815L8.22266 20.6135C21.8911 25.6026 28.6727 28.6245 37.5884 36.1589C29.6274 27.0849 25.4405 21.8803 20.1286 11.6815Z"
                  stroke="#00A3FF"
                  strokeWidth="1.50772"
                />
                <path
                  d="M5.56504 33.1608L1.8252 45.4653C15.6083 41.4357 22.7871 39.7985 34.4422 40.0051C22.5744 38.2665 16.0637 37.0658 5.56504 33.1608Z"
                  stroke="#00A3FF"
                  strokeWidth="1.50772"
                />
                <path
                  d="M43.6853 3.88823L30.9722 2.17285C37.1622 15.1628 39.932 22.003 41.6096 33.5705C41.4054 21.5452 41.5365 14.9082 43.6853 3.88823Z"
                  stroke="#00A3FF"
                  strokeWidth="1.50772"
                />
              </svg>
      ...
      <div className={styles.try}>
        <div className={styles.container}>
          ...
          <div>
            <h2>
              TRY SLAYT NOW <span>GET THE APP!</span>
            </h2>
            <section className={styles.trialSection}>
      ...
      <div className={styles.excite}>
        <div className={styles.container}>
          <h2>
            <span>EXCITE YOUR KIDS</span> BY GETTING THEM ON SLAYT
          </h2>
          <p>
            Turn Chores into Adventures: Ignite Excitement with SLAYT&apos;s
      ...
      <div className={styles.learn} id="features">
        <div className={styles.container}>
          <h2>
            LEARN MORE ABOUT <span>SLAYT</span>
          </h2>
      ...
      <div className={styles.start}>
        <div className={styles.container}>
          <h2>
            START YOUR FREE TRIAL <span>TODAY</span>
          </h2>
          <section className={styles.trialSection}>
            <FreeTrial backgroundColor="#E5F6FF" />
          </section>
